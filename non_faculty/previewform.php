	...
	<!-- header -->
	 <div id="top">
	  <div id="logo_2" >
			...
			<center><span style="margin-right:60px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><a href="index.php">????????? ???????????? ??????? ?????<br />National Institute of Technology Silchar</a></h1></span></center>
...
<table width="800px">
		...
		<br />
			...
			<center><a href="form.php"><button id="edit">Edit</button></a>&nbsp;<a href="final_lock.php"><button id="final_lock">Lock</button></a></center>
