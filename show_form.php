	...
	<hr />
			...
			<table class="table_main" >
				...
				<tr>
					...
					<td>(b) Age on 01/03/2015<br/>(DD/MM/YYYY)<span style="color:red;font-size:16px;">&#42;</span></td>
					<td colspan="2">:
...
<?php echo  $d4['advertisement_no']; ?> Dated : 02/March/2015 ) 
