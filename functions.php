...
function save_form(){
	...
	$save1_result = mysqli_query($conn, $save1_query) or die(mysql_error($conn));
	...
	$save2_result = mysqli_query($conn, $save2_query) or die(mysql_error($conn));
	...
	$save3_result = mysqli_query($conn, $save3_query) or die(mysql_error($conn));
	...
	$save4_result = mysqli_query($conn, $save4_query) or die(mysql_error($conn));
}
