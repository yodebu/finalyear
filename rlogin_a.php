...
<br />
	<?php
		...
		{
		?>
	<center><span style="color:red"><b>Wrong email & password combination</b></span></center>
	<?php
	}
	?>
			...
			<div class="block_flip">
						...
						<br />
						<br />
						<p>To retrieve your password type your email address and submit. Reset link will be sent to you!.</p>
